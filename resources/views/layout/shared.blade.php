          ...
          <ul class="navbar-nav mr-auto left">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="/food">Makanan</a>
                  <a class="dropdown-item" href="/dessert">Minuman</a>
                </div>
              </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/cart">Pembelian</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="/transactionHistory">Transaksi</a>
                </li>
            @endif
